...
|#|Review Area|Questions to ask|Acceptance Criteria|
|---|---|---|---|
...
|3|**Master Rules**|Are master segmentations/lists being used if appropriate or where appropriate?|**Yes or not applicable:** Master lists/segmentations are designed to reduce the number of fields you must reference and reduce the risk of human error. You should be confident of your rules if you do not use master lists/segmentations.||
