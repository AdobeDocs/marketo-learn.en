...
|3|**Data**|If there is a form in the campaign, has the form been tested? Do all triggers flow as expected? Do all form fields map accurately? Can you prove this, having checked a lead record's activity log - not just the fields?|**Yes:** <br>If you cannot answer with a yes, you should test this.|
...
|2|**Sender name**|Checked with brand owner, confirmed to be safe for use?|**Yes:** <br><br>If you cannot answer with a yes, you should check before proceeding.|
